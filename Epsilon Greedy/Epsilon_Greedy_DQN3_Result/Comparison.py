...
CartPole_DQN = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Exploration_Param_0.1.npy')
CartPole_DQN_2 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Exploration_Param_0.3.npy')
CartPole_DQN_3 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Exploration_Param_0.5.npy')
CartPole_DQN_4 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Exploration_Param_0.9.npy')
