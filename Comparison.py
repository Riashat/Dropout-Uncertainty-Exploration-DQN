...
Dropout_Epsilon = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/Dropout_EpsilonGreedy.npy')

Dropout_Thompson = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/Dropout_Epsilon_Thompson.npy')

Optimized_Dropout = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/Optimized_Dropout_EpsilonGreedy.npy')
...
def multiple_plot_episode_stats(stats1, stats2, stats3,  stats4, eps,  smoothing_window=200, noshow=False):
    ...
    cum_rwd_4, = plt.plot(eps, rewards_smoothed_4, label="Optimized Dropout Epsilon Greedy Exploration")    
...
def main():
	multiple_plot_episode_stats(Epsilon,  Dropout_Epsilon, Dropout_Thompson, Optimized_Dropout, eps)
