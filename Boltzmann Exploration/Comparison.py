...
CartPole_DQN = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Decaying_Boltzmann_Exploration_Param_0.1.npy')
CartPole_DQN_2 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Decaying_Boltzmann_Exploration_Param_0.3.npy')
CartPole_DQN_3 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Decaying_Boltzmann_Exploration_Param_0.5.npy')
CartPole_DQN_4 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Decaying_Boltzmann_Exploration_Param_0.9.npy')
CartPole_DQN_5 = np.load('CartPole_V0_cumulative_reward_Q_Learning_DQN3_Decaying_Boltzmann_Exploration_Param_1.npy')
...
def same_figure_multiple_plot_episode_stats(stats, stats2, stats3, stats4,  stats5, eps,  smoothing_window=50, noshow=False):
    ...
    cum_rwd_5, = plt.plot(eps, rewards_smoothed_5, label="Epsilon Parameter = 1")

    plt.legend(handles=[cum_rwd, cum_rwd_2, cum_rwd_3, cum_rwd_4, cum_rwd_5])
    plt.xlabel("Epsiode")
    plt.ylabel("Epsiode Reward (Smoothed)")
    plt.title("DQN on Cart Pole")
    plt.show()
...
def main():
	same_figure_multiple_plot_episode_stats(CartPole_DQN, CartPole_DQN_2, CartPole_DQN_3, CartPole_DQN_4,  CartPole_DQN_5, eps)
