"""
Using a high probability of dropout to see changes in dropout uncertainty estimates
...
def run_episode(env,
    ...
    for i in range(max_step):
        ...
        action, variance = agent.dropout_highest_variance_low_probability(state)
...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Cum_Rwd_' + 'Dropout_Highest_Variance_Low_Prob_' + str(e) + '.npy', total_reward)
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Variance_Values_' + 'Dropout_Highest_Variance_Low_Prob_' + str(e) + '.npy', variance_steps_episodes)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'   + 'Average_Cum_Rwd_' + 'Dropout_Highest_Variance_Low_Prob_' + '.npy', Average_Cum_Rwd)
