"""
Pick actions with highest variance estimated from Q network from dropout
"""
...
def run_episode(env,
    ...
    for i in range(max_step):
        ...
        action, variance = agent.dropout_highest_variance_decaying_dropout_probability(state)
...
for e in range(Experiments):
    ...
    dropout_prob = 0.7
    agent = AgentEpsGreedy(n_actions=n_actions, value_function_model=value_function, eps=dropout_prob)
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Cum_Rwd_' + 'Dropout_Highest_Variance_Decaying_Probability' + str(e) + '.npy', total_reward)
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Variance_Values_' + 'Dropout_Highest_Variance_Decaying_Probability' + str(e) + '.npy', variance_steps_episodes)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'   + 'Average_Cum_Rwd_' + 'Dropout_Highest_Variance_Decaying_Probability' + '.npy', Average_Cum_Rwd)


print "All Experiments DONE - Deep Q Learning"

print "Dropout with Decaying probability - highest variance estimate"
